                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input value={quotePhone} onChange={(e) => setQuotePhone(e.target.value)} placeholder="0731 496 117" className="w-full px-4 py-3 rounded-xl border-2 border-[#d8e6dd] bg-white text-sm focus:outline-none focus:border-[#1a3d2b] transition" />
                        </div>
                      </div>
                      <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <a href="tel:0731496117" className="flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-[#d8e6dd] text-sm font-semibold text-[#1a3d2b] hover:bg-[#f5f8f6] transition">📞 Call: 0731 496 117</a>
                        <a href="https://wa.me/256731496117" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-[#d8e6dd] text-sm font-semibold text-[#1a3d2b] hover:bg-[#f5f8f6] transition">💬 WhatsApp Us</a>
                      </div>
                    </div>
                  )}
                </CardContent>
