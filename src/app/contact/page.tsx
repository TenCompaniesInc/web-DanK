...
const contactInfo = [
  ...
  { icon: <Phone size={20} />, label: "Phone", value: "0731 496 117", sub: "Call or WhatsApp anytime", href: "tel:0731496117" },
  { icon: <Clock size={20} />, label: "Hours", value: "Sun – Fri · 7am – 7:30pm", sub: "Closed on Saturdays", href: null },
  { icon: <Mail size={20} />, label: "WhatsApp", value: "+256 731 496 117", sub: "Fast response within minutes", href: "https://wa.me/256731496117" },
];
                ...
                <div className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input name="phone" value={form.phone} onChange={handleChange} placeholder="0731 496 117" className="w-full px-4 py-3 rounded-xl border-2 border-[#d8e6dd] bg-white text-sm focus:outline-none focus:border-[#1a3d2b] transition" />
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="flex gap-3 pt-1">
                    <a href="tel:0731496117" className="flex-1 text-center text-xs font-semibold text-[#1a3d2b] border-2 border-[#d8e6dd] rounded-xl py-3 hover:bg-[#f5f8f6] transition">📞 Call: 0731 496 117</a>
                    <a href="https://wa.me/256731496117" target="_blank" rel="noreferrer" className="flex-1 text-center text-xs font-semibold text-[#1a3d2b] border-2 border-[#d8e6dd] rounded-xl py-3 hover:bg-[#f5f8f6] transition">💬 WhatsApp Us</a>
                  </div>
                </div>
              )}
            </FadeIn>
