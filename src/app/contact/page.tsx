...
const contactInfo = [
  {
    icon: <MapPin size={20} />,
    label: "Address",
    value: "26d Kisenyi Road, Kampala",
    sub: "Come in anytime",
    href: "https://maps.google.com/?q=Kisenyi+Road+Kampala",
  },
  {
    icon: <Phone size={20} />,
    label: "Phone",
  ...
  },
  {
    icon: <Mail size={20} />,
    label: "WhatsApp",
    value: "+256 700 212 147",
    sub: "Fast response within minutes",
...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* HERO */}
      <section
        className="pt-16 min-h-[40vh] flex items-end justify-start relative overflow-hidden"
        style={{ background: "linear-gradient(135deg, #0d2418 0%, #1a3d2b 60%, #2d6a4f 100%)" }}
      >
        <div
          className="absolute inset-0 opacity-10"
          style={{ backgroundImage: "radial-gradient(circle at 30% 50%, #c8961e 0%, transparent 60%)" }}
        />
        <div className="relative z-10 max-w-7xl mx-auto px-10 pb-14 pt-20">
          <motion.p
          ...
          >
            ...
            <span className="text-[#c8961e]">on Kisenyi Road.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.7 }}
            className="text-white/60 text-base max-w-lg leading-relaxed"
          >
            Walk in, call us, WhatsApp, or send a message below.
                  ...
                  <a href={item.href} target="_blank" rel="noreferrer" className="block h-full">
                    <Card className="border-2 border-[rgba(200,230,210,0.7)] bg-white/65 backdrop-blur-md hover:-translate-y-1 hover:shadow-lg transition-all duration-200 h-full cursor-pointer">
                      <CardContent className="p-5">
                        <div className="w-10 h-10 rounded-xl bg-[#f0f7f2] border border-[#d8e6dd] flex items-center justify-center text-[#1a3d2b] mb-4">
                          {item.icon}
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <FadeIn>
              ...
              <h2 className="text-3xl font-bold tracking-tight text-[#141414] mb-8">
                How can we help you?
              </h2>
              ...
              {sent ? (
                <motion.div
                  ...
                  className="flex flex-col items-center justify-center text-center py-16 px-8 rounded-2xl border-2 border-[rgba(200,230,210,0.7)] bg-[#f5f8f6]"
                >
                  ...
                  <p className="text-zinc-400 text-sm mb-6 max-w-xs leading-relaxed">
                    Thanks {form.name}. We will get back to you on{" "}
                    <strong className="text-[#1a3d2b]">{form.phone}</strong> within minutes.
                  </p>
                  <button
                    onClick={() => {
                      setSent(false);
                    ...
                    className="text-sm font-semibold text-[#1a3d2b] underline"
                  >
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    className="w-full bg-[#1a3d2b] hover:bg-[#2d6a4f] text-white h-12 font-semibold text-sm flex items-center justify-center gap-2"
                  ...
                  <div className="flex gap-3 pt-1">
                    <a
                      href="tel:0700212147"
                      className="flex-1 text-center text-xs font-semibold text-[#1a3d2b] border-2 border-[#d8e6dd] rounded-xl py-3 hover:bg-[#f5f8f6] transition"
                    >
                      📞 Call: 0700 212 147
                    </a>
                    <a
            ...
            <FadeIn delay={0.15}>
              ...
              <h2 className="text-3xl font-bold tracking-tight text-[#141414] mb-6">
                Visit the Store
              </h2>

              <div className="rounded-2xl overflow-hidden border-2 border-[rgba(200,230,210,0.7)] mb-6 h-64">
                <iframe
                  title="DAN K Store Location"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.757!2d32.5796!3d0.3136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMCsxOCcyOS4yIk4gMzLCsDM0JzQ2LjYiRQ!5e0!3m2!1sen!2sug!4v1234567890"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                ...
                <div className="p-5 rounded-2xl border-2 border-[rgba(200,230,210,0.7)] bg-[#f5f8f6]">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400 mt-0.5">26d Kisenyi Road, Kampala, Uganda</p>
                      <a
                        href="https://maps.google.com/?q=Kisenyi+Road+Kampala"
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs font-semibold text-[#1a3d2b] underline mt-2 inline-block"
                      >
                        Get Directions →
                      </a>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-1">
                        {[
                          { day: "Monday – Friday", time: "7:00am – 7:30pm" },
                          { day: "Saturday", time: "7:00am – 7:30pm" },
                          { day: "Sunday", time: "7:00am – 7:30pm" },
                        ].map((h) => (
      ...
      <section className="py-16 bg-[#0d2418]">
        <div className="max-w-2xl mx-auto px-6 text-center">
          <FadeIn>
            ...
            <p className="text-lg text-white/70 italic leading-relaxed mb-4">
              "Ask and it will be given to you; seek and you will find;
              knock and the door will be opened to you."
            </p>
            <p className="text-[#c8961e] text-xs font-bold tracking-[2px] uppercase">
              Matthew 7:7
            </p>
          </FadeIn>
        </div>
      ...
      <footer className="bg-[#141414] py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-600">
          <p>© 2025 DAN K CHEAP STORES LTD · Kampala, Uganda</p>
