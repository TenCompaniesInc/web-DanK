        ...
        {sent ? (
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <input value={contact} onChange={(e) => setContact(e.target.value.replace(/[^0-9]/g, "").slice(0, 10))} inputMode="numeric" placeholder="e.g. 0731496117" className="w-full px-4 py-3 rounded-xl border-2 border-[#d8e6dd] bg-white text-sm focus:outline-none focus:border-[#1a3d2b] transition" />
            </div>
            <div>
...
export default function ProductsPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-50">
      ...
      {/* FLOATING SUPPORT */}
      <a href="https://wa.me/256731496117" target="_blank" rel="noreferrer" className="fixed bottom-8 right-8 z-40 bg-[#25D366] text-white w-14 h-14 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-transform border-4 border-white" title="Chat with Support on WhatsApp">
